...
public class PromptService {
    ...
    public static final String SYSTEM_PROMPT = """
            ...
            - Si el usuario declara el saldo actual de una cuenta/billetera SIN usar un verbo de movimiento (ej: "tengo 50000 en Mercado Pago", "tengo 200 dólares en el Banco Galicia", "en mi Ualá tengo 15000 pesos"), interpretalo como carga de saldo inicial: type "income", description "Saldo inicial", category "General", icon "ArrowDownLeft", e incluí SIEMPRE el campo account (nombre normalizado del banco/billetera) y el campo "isBalanceDeclaration":true. Ejemplo: "tengo 50000 en Mercado Pago" → {"type":"income","description":"Saldo inicial","amount":50000,"category":"General","icon":"ArrowDownLeft","daysAgo":0,"suggestRecurring":false,"account":"Mercado Pago","isBalanceDeclaration":true}
