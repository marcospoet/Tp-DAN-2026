...
public class RabbitConfig {
    ...
    public static final String EXCHANGE = "pesito.events";
    ...
    @Bean
    public TopicExchange pesitoExchange() {
    ...
    @Bean
    public Binding txnUserDeletedBinding(Queue txnUserDeletedQueue, TopicExchange pesitoExchange) {
