...
public class AuditAspect {
    ...
    @Pointcut("execution(* com.budgetbuddy.transaction.service.impl.TransactionServiceImpl.create(..))")
    public void createTransaction() {}

    @Pointcut("execution(* com.budgetbuddy.transaction.service.impl.TransactionServiceImpl.update(..))")
    public void updateTransaction() {}

    @Pointcut("execution(* com.budgetbuddy.transaction.service.impl.TransactionServiceImpl.delete(..))")
